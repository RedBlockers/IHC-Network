...
export const displayIcons = () => {
    ...
    axios.post("/guilds/getGuildsByUser", { token: token }).then((response) => {
        if (response.status === 200) {
            ...
            guilds.forEach((guild) => {
                ...
                const contextMenu = new ContextMenu(
                    document.getElementById(`guild_${guild.guildId}`),
        ...
        const selctedGuildSelectionBar = document.getElementById(
